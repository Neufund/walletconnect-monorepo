...
const web3_subprovider_1 = tslib_1.__importDefault(require("@walletconnect/web3-subprovider"));
...
class WalletConnectProvider extends ProviderEngine {
    constructor(opts) {
        super(Object.assign(Object.assign({}, DefaultOptions), opts));
        ...
        this.addProvider(new web3_subprovider_1.default({ bridge }));
